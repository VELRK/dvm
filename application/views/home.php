                    ...
                    <div dir="ltr" class="swiper-container thumbs-swiper-column">
                        <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-img">
                                            ...
                                            <img src="<?php echo htmlspecialchars($bannerImage); ?>" 
                                                 ...
                                                 loading="<?php echo $isFirstBanner ? 'eager' : 'lazy'; ?>"
                                                 decoding="async"
                                                 <?php if ($isFirstBanner): ?>fetchpriority="high"<?php else: ?>fetchpriority="low"<?php endif; ?>
                            ...
                            <?php else: ?>
                                ...
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="https://homelengo.vercel.app/images/slider/slider-5.jpg" alt="" width="1920" height="1080" loading="eager" decoding="async" fetchpriority="high">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="https://homelengo.vercel.app/images/slider/slider-5-1.jpg" alt="" width="1920" height="1080" loading="lazy" decoding="async" fetchpriority="low">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="https://homelengo.vercel.app/images/slider/slider-5-2.jpg" alt="" width="1920" height="1080" loading="lazy" decoding="async" fetchpriority="low">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="https://homelengo.vercel.app/images/slider/slider-5-3.jpg" alt="" width="1920" height="1080" loading="lazy" decoding="async" fetchpriority="low">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="location-marquee-container" style="position: relative;">
                            <div dir="ltr" class="swiper location-marquee-swiper">
                                <div class="swiper-wrapper" id="locationMarqueeTrack">
                                    ...
                                    ?>
                                        <div class="swiper-slide">
                                            <a href="<?php echo base_url('our-projects?location='.urlencode($locationItem['key'])); ?>" class="location-marquee-card">
            ...
            <section class="flat-section flat-location-v2" >
                <div class="container">
                    ...
                    <?php foreach ($firstArray as $locationKey => $locationProperties): ?>
                        ...
                        <a href="<?php echo base_url('our-projects?location='.urlencode($locationKey)); ?>" class="item-<?php echo $locationKey; ?> box-location-v2 hover-img">
                            <div class="box-img img-style">
                                ...
                                <img style="height: 300px; width: 100%; object-fit: cover;" class="lazyload" data-src="<?php echo htmlspecialchars($locationImage); ?>"
                                    src="<?php echo htmlspecialchars($dvm_lazy_img_placeholder); ?>" width="400" height="300" loading="lazy" decoding="async" alt="<?php echo htmlspecialchars($locationName, ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                            <div class="content">
                    ...
                    <?php foreach ($secondArray as $locationKey => $locationProperties): ?>
                        ...
                        <a href="<?php echo base_url('our-projects?location='.urlencode($locationKey)); ?>" class="<?php echo $itemClass; ?> box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <?php 
                                // Use location's own image first, then fall back to property image
                                $locationImage = '';
            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="viewAllnew" role="tabpanel">
                    ...
                    <div class="text-center">
                        <a href="<?php echo base_url('our-projects'); ?>" class="tf-btn btn-view primary size-1 hover-btn-view">
