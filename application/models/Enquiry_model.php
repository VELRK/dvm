...
class Enquiry_model extends CI_Model {
    ...
    {
        // Actual table columns: id, property_id, name, email, phone, message, status, created_at, user_id
    ...
    /**
     * Get enquiries by user ID (direct match on enquiries.user_id column)
