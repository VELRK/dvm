    ...
    <div class="login-container" style="width: 100%; max-width: 450px; background: white; padding: 30px 20px; position: relative;">
        ...
        <form id="loginForm" method="post">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                <a href="<?php echo base_url('home'); ?>" style="color: #2c3e50; text-decoration: none; font-size: 16px; font-weight: 500; display: inline-flex; align-items: center; gap: 8px; transition: color 0.3s ease;" onmouseover="this.style.color='#3498db'" onmouseout="this.style.color='#2c3e50'">
                    Skip for now
