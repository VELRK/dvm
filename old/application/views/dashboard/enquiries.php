                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="listing-box">
                                                        ...
                                                        <div class="content">
                                                            <div class="title">
                                                                <a href="<?php echo base_url('property-details-v1.html'); ?>" class="link">
                                                            ...
                                                            ?></div>
                                                            <div class="text-btn text-primary"><?php echo htmlspecialchars($item['propertyPrice'] ?? 'Price on Request'); ?></div>
