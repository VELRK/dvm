    ...
    <div class="homelengo-box list-style-1 list-style-2 line">
        ...
        <div class="archive-bottom">
            ...
            <div class="content-bottom">
                ...
                <h6 class="price">
                    <?php 
                    if (!empty($property['propertyPriceRange'])) {
                        echo 'INR ' . number_format((float)$property['propertyPriceRange'], 0);
                    } else {
                        echo 'Price on Request';
                    }
                    ?>
                    <?php if (!empty($property['propertyPriceRangeText'])): ?>
                        <br><span class="price-text" style="font-size: 0.9em; color: #666; font-weight: normal;"><?php echo htmlspecialchars($property['propertyPriceRangeText']); ?></span>
                    <?php endif; ?>
                </h6>
            </div>
        </div>
