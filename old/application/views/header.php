...
<head>
    ...
    if (isset($recaptcha_config['enabled']) && $recaptcha_config['enabled'] && !empty($recaptcha_config['site_key']) && $recaptcha_config['site_key'] !== '6LfYourSiteKeyHere') {
        echo '<script src="https://www.google.com/recaptcha/api.js?render=' . htmlspecialchars($recaptcha_config['site_key']) . '"></script>';
    }
    ?>
        ...
        <div id="pagee" class="clearfix">
            ...
            <header class="main-header fixed-header">
                            ...
                            <div class="inner-header">
                                <div class="inner-header-left">
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="<?php echo base_url('home'); ?>"><img src="<?php echo base_url('assets/images/logo/logo@2x.webp'); ?>"
                                        ...
                                        <nav class="main-menu show navbar-expand-md">
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    <li class="<?php echo ($page == 'home') ? 'current' : ''; ?>"><a href="<?php echo base_url('home'); ?>">Home</a></li>
                                                    <li class="<?php echo ($page == 'about') ? 'current' : ''; ?>"><a href="<?php echo base_url('about'); ?>">About Us</a></li>
                                                    <li class="<?php echo ($page == 'listing' || $page == 'property_detail') ? 'current' : ''; ?>"><a href="<?php echo base_url('listing'); ?>">Our Projects</a></li>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="<?php echo base_url('home'); ?>"><img src="<?php echo base_url('assets/images/logo/logo@2x.webp'); ?>" alt="nav-logo"
